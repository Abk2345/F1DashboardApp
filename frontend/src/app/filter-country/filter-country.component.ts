// component to show data related to searched countries
...
export class FilterCountryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //  setting up all the data for the page
  ...
  getRelevantData() {
    this.driverService.getDataWithCountryName(this.country_name).subscribe((data) => {
      ...
      // Handling the case where data is null or undefined or has zero content
      ...
      // performing calculations on data -> 1st total race_wins, total championships
